...
export default function Tech() {
  ...
  const topNews = async()=>{
    try {
      const res = await axios.get(`https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=30d6271c41a148ebbc8ae887904ea0f5`)
  ...
  return (
    <div>
     ...
     <Typography variant="h4" Align="center">Technology News</Typography>
