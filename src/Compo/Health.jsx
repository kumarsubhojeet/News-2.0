...
export default function Health() {
  ...
  const topNews = async()=>{
    try {
      ...
      https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=30d6271c41a148ebbc8ae887904ea0f5`)
  ...
  return (
    <div>
     ...
     <Typography variant="h4" Align="center">Health News</Typography>
